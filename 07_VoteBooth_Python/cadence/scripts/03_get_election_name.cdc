...
access(all) fun main(electionId: UInt64, voteboxAddress: Address?): String? {
    if (voteboxAddress == nil) {
        ...
        return voteboxRef.getElectionName(electionId: electionId)
    }
