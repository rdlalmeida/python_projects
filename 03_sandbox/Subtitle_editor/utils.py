...
def print_folder(base_path, file_list):
    """
    Simple method that prints the contents of a given filelist, that is, the result of os.listdir
    :param base_path: a string containing the path to the folder in question
    :param file_list: list object resulting from os.listdir method application
    :return: None. The method simply prints the folder's contents one per line in the std.out
    """
    print("Contents of " + str(base_path) + ":")
